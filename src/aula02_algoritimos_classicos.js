...
function verificarPalindromo(palindromo){
    ...
    debugger;
    for(inicio = 0;inicio<fim;inicio++){ //o for executa uma instrução se atender a condição passada
        if(palindromo[inicio]!=palindromo[fim]){return false}//acessar uma letra por indice usando colchete
        fim--;
    }
    return true
}
